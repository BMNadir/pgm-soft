...
public interface IDefinitions {
    ...
    // BOOTLOADER commands
    static final byte QUIT_BOOT                     = (byte) 0xFF;
    static final byte GET_BOOTLOADER_VERSION        = 0x21;
    static final byte RESUME_COMM                   = 0x22;
    ...
    static final int UPLOAD_BUFFER_SIZE = 128; 
}
